        ...
        try {
            ...
            if ($item == null) {
                ...
                EbayItems::create([
                    ...
                    'title' => $data['title'],
                    'category_id' => $cat_id,
                    'globalId' => 'EBAY-'. $data['details']['Site'] ?? null,
                    'galleryURL' => $data['details']['GalleryURL'] ?? null,
                    'viewItemURL' => $data['details']['ViewItemURLForNaturalSearch'] ?? null,
                    'autoPay' => $data['details']['AutoPay'] ?? null,
                    'postalCode' => $data['details']['PostalCode'] ?? null,
                    'location' => $data['details']['Location'] ?? null,
                    'country' => $data['details']['Country'] ?? null,
                    'returnsAccepted' => $data['details']['ReturnPolicy']['ReturnsAccepted'] == 'ReturnsNotAccepted' ? false : true,
                    'condition_id' => $data['details']['ConditionID'] ?? null,
                    'pictureURLLarge' => count($data['details']['PictureURL']) > 0 ? $data['details']['PictureURL'][0] : null,
                    'pictureURLSuperSize' => count($data['details']['PictureURL']) > 0 ? $data['details']['PictureURL'][count($data['details']['PictureURL'])-1] : null,
                    'listing_ending_at' => $data['details']['EndTime'] ?? null,
