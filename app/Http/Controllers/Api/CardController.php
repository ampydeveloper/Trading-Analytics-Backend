...
//                return response()->json(['message' => 'File uploaded unsuccessfully'], 500);
    ...
    public function __groupGraphDataPerDay($days, $data) {
        $months = null;
        $years = null;
        $cmp = $days;
        $cmpSfx = 'days';
