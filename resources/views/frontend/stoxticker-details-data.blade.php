...
<meta name="description" content="StoxTicker: <?php echo $finalData['board']->name; ?> $<?php echo $finalData['total_card_value']; ?> Board Cost Change $<?php echo $finalData['sx_value']; ?> <?php echo $finalData['pert_diff']; ?>%">
...
<meta  data-hid="card-og-description" property="og:description" content="StoxTicker: <?php echo $finalData['board']->name; ?> $<?php echo $finalData['total_card_value']; ?> Board Cost Change $<?php echo $finalData['sx_value']; ?> <?php echo $finalData['pert_diff']; ?>%">
...
<meta  data-hid="card-twitter-description" property="twitter:description" content="StoxTicker: <?php echo $finalData['board']->name; ?> $<?php echo $finalData['total_card_value']; ?> Board Cost Change $<?php echo $finalData['sx_value']; ?> <?php echo $finalData['pert_diff']; ?>%">
