<div class="slabstox-mail-box" style="font-family: Georgia, Arial, sans-serif;font-size: 16px;line-height: 19px;">
    ...
    <div class="content-mail" style="width: 100%;background: #1ce783;padding: 50px 0;">
        <div class="content-mail-inner" style="padding: 40px 50px;width: 80%;margin: 0 auto;background: #fff;">
            <h1 style="margin-top: 0;margin-bottom: 20px;line-height: 35px;">Congratulations!</h1>
            <p style="margin-top: 0;margin-bottom: 15px;">You've officially created an account to use the 100%-free SlabStoxPro platform. Now it's time to start your journey on SlabStoxPro by tracking the hottest Slabs, adding Slabs to your portfolio, and getting updated pricing information on the Slabs you want to follow. You can even request for us to add a Slab to our database!</p>
